...
def newton_approx(f, f_diff, start_points, max_iterations = 200, border = 10**(-4)):
    """
    ...
    for y in range(y_dim):
        for x in range(x_dim):
            ...
            while iterations < max_iterations:
                jacobi = np.array([[f_diff[0][0](point[0],point[1]), f_diff[0][1](point[0],point[1])],[f_diff[1][0](point[0],point[1]), f_diff[1][1](point[0],point[1])]])
